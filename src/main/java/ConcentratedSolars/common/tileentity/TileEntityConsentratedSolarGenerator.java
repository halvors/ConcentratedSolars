package concentratedsolars.common.tileentity;

import java.util.ArrayList;
import java.util.EnumSet;

import concentratedsolars.ConcentratedSolars;
...
public class TileEntityConcentratedSolarGenerator extends TileEntityGenerator
{
