...
public class BlockSolarPanel extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		topIcon = iconRegister.registerIcon(Reference.PREFIX + "blockSolarPanel_top");
		sideIcon = iconRegister.registerIcon(Reference.PREFIX + "blockSolarPanel_side");
		bottomIcon = iconRegister.registerIcon(Reference.PREFIX + "blockSolarPanel_bottom");
	}
